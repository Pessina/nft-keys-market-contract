...
fn test_krnl_validation() {
    ...
    // Test data
    let sender = "4174678c78fEaFd778c1ff319D5D326701449b25".to_string();
    ...
    assert!(contract.is_krnl_authorized(params, payload, sender));
}
...
fn test_decode_kernel_responses() {
    ...
    let kernel_responses = "".to_string();
